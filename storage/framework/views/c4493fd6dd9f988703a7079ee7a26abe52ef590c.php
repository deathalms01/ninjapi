...
<?php $__env->startSection('head'); ?>
	<div class="inner cover">
            ...
            <form method="post" action="#">
              <div class="lead"><input type="text" name = "name" style="width: 600px; color: #333333; border-radius: 5px;"></div>

              <div class="lead" style="display: inline;">
                <input type="submit" href="#" class="btn btn-lg btn-default" style="width: 140px;" value = "Facebook">
                <input type="submit" href="#" class="btn btn-lg btn-default" style="width: 140px;" value = "Twitter">
              </div>
            </form>
